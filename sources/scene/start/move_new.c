...
void apply_moving_new(rpg_t *rpg)
{
...
void do_moving_new_3(rpg_t *rpg)
{
	for (int i = 0; i < 4; i++) {
	...
	apply_moving_new(rpg);
}

void do_moving_new_2(rpg_t *rpg)
{
